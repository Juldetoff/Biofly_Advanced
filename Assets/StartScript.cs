...
public class StartScript : MonoBehaviour
{
    ...
    public CinemachineSmoothPath Prefabpath; //prefab qu'on va instancier puis lui donner 11 points
    ...
    public TimelineAsset timeline; //check c'est quoi la classe
    public PlayableDirector director;

    public int camCount = 0; //compteur de cam pour les instantiates et les noms

    public SysCam prefabCam;

    TrackAsset originalVirtualTrack; // assuming the original virtual camera is the first track
    TrackAsset originalPhysicalTrack; // assuming the new virtual camera is the second track
    ...
    void Start()
    {
        ...
        for(int i=0; i<nBCamera; i++){ 
            ...
            //TODO: ici check parmi les infos du fichier entrée le type de noise à mettre
            syscambruit.vcam.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_NoiseProfile = Shake6D;
